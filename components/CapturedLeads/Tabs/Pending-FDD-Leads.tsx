...
const leads: Lead[] = [
    { id: 'CLIENT-0024', name: 'Alice Smith', company: 'Bob Johnson', budget: '$2,000-$3,000', date: '15 Jan 2022', stage: 'FDD Signed', reminderSent: false },
    { id: 'CLIENT-0025', name: 'Bob Johnson', company: 'Carlos Martinez', budget: '$3,000-$4,000', date: '3 Feb 2022', stage: 'FDD Signed', reminderSent: true },
    { id: 'CLIENT-0026', name: 'Charlie Brown', company: 'Diana Wong', budget: '$4,000-$5,000', date: '28 Mar 2022', stage: 'FDD Signed', reminderSent: false },
    { id: 'CLIENT-0027', name: 'Diana Prince', company: 'Eva Green', budget: '$5,000-$6,000', date: '7 Apr 2022', stage: 'FDD Signed', reminderSent: true },
    { id: 'CLIENT-0028', name: 'Ethan Hunt', company: 'Frank Brown', budget: '$6,000-$7,000', date: '19 May 2022', stage: 'FDD Signed', reminderSent: false },
    { id: 'CLIENT-0029', name: 'Fiona Gallagher', company: 'Grace Lee', budget: '$7,000-$8,000', date: '11 Jun 2022', stage: 'FDD Signed', reminderSent: false },
    { id: 'CLIENT-0030', name: 'George Costanza', company: 'Henry King', budget: '$8,000-$9,000', date: '22 Jul 2022', stage: 'FDD Signed', reminderSent: true },
    { id: 'CLIENT-0031', name: 'Hannah Baker', company: 'Ivy Patel', budget: '$9,000-$10,000', date: '14 Aug 2022', stage: 'FDD Signed', reminderSent: false },
    { id: 'CLIENT-0032', name: 'Ian Malcolm', company: 'Jack Taylor', budget: '$10,000-$11,000', date: '5 Sep 2022', stage: 'FDD Signed', reminderSent: true },
    { id: 'CLIENT-0033', name: 'Jack Sparrow', company: 'Kathy White', budget: '$11,000-$12,000', date: '30 Oct 2022', stage: 'FDD Signed', reminderSent: false },
    { id: 'CLIENT-0034', name: 'John Doe', company: 'ABC Corp', budget: '$2,000-$3,000', date: '10 Oct 2022', stage: 'FDD Signed', reminderSent: false },
    { id: 'CLIENT-0035', name: 'Jane Smith', company: 'XYZ Inc', budget: '$3,000-$4,000', date: '20 Nov 2022', stage: 'FDD Signed', reminderSent: true },
    { id: 'CLIENT-0036', name: 'Mike Wilson', company: 'Tech Solutions', budget: '$4,000-$5,000', date: '5 Dec 2022', stage: 'FDD Signed', reminderSent: false },
    { id: 'CLIENT-0037', name: 'Sarah Johnson', company: 'Global Services', budget: '$5,000-$6,000', date: '15 Jan 2023', stage: 'FDD Signed', reminderSent: false },
    { id: 'CLIENT-0038', name: 'Tom Brown', company: 'Digital Media', budget: '$6,000-$7,000', date: '25 Feb 2023', stage: 'FDD Signed', reminderSent: true },
    { id: 'CLIENT-0039', name: 'Lisa Anderson', company: 'Creative Agency', budget: '$7,000-$8,000', date: '8 Mar 2023', stage: 'FDD Signed', reminderSent: false },
    { id: 'CLIENT-0040', name: 'David Lee', company: 'Marketing Pro', budget: '$8,000-$9,000', date: '18 Apr 2023', stage: 'FDD Signed', reminderSent: false },
    { id: 'CLIENT-0041', name: 'Emily Davis', company: 'Business Solutions', budget: '$9,000-$10,000', date: '28 May 2023', stage: 'FDD Signed', reminderSent: true },
];

export default function PendingFDDLeads() {
    ...
    const tableHeaders = [
        ...
        { label: '', hasCheckbox: false, hasSortIcon: false, className: 'py-4 px-4' },
    ];
                    ...
                    <tbody>
                        {paginatedLeads.map((lead, index) => (
                            ...
                            >
                                ...
                                <td className="py-4 px-4">
                                    {/* Action column - Send Reminder button or Sent status */}
                                    {lead.reminderSent ? (
                                        <div className="inline-flex items-center gap-1.5 px-3 py-2 bg-[#FFF5E3] text-[#504f54] rounded-sm">
                                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M7 0C3.13401 0 0 3.13401 0 7C0 10.866 3.13401 14 7 14C10.866 14 14 10.866 14 7C14 3.13401 10.866 0 7 0ZM10.5 5.25L6.125 9.625L3.5 7L4.375 6.125L6.125 7.875L9.625 4.375L10.5 5.25Z" fill="#24282E" />
                                            </svg>
                                            <span className="text-xs font-medium text-[#24282E]">Sent</span>
                                        </div>
                                    ) : (
                                        <button className="flex items-center gap-1.5 px-3 py-2 bg-[#ffce74] rounded-sm text-xs text-[#504f54] font-medium hover:opacity-90 transition-opacity">
                                            <svg width="16" height="16" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M5.84838 10.723C6.38451 10.723 6.82317 10.2843 6.82317 9.74816H4.87359C4.87359 10.2843 5.31224 10.723 5.84838 10.723ZM8.77275 7.79858V5.36161C8.77275 3.8653 7.97829 2.6127 6.57947 2.28127V1.94984C6.57947 1.5453 6.25292 1.21875 5.84838 1.21875C5.44384 1.21875 5.11729 1.5453 5.11729 1.94984V2.28127C3.72334 2.6127 2.92401 3.86043 2.92401 5.36161V7.79858L1.94922 8.77337V9.26077H9.74754V8.77337L8.77275 7.79858ZM7.79796 8.28598H3.8988V5.36161C3.8988 4.15287 4.63476 3.16833 5.84838 3.16833C7.06199 3.16833 7.79796 4.15287 7.79796 5.36161V8.28598Z" fill="#504F54" />
                                            </svg>
                                ...
                                <td className="py-4 px-4">
                                    {/* Delete and three dots in same column - same layout as All-Leads */}
                                    <div className="flex items-center justify-end gap-2">
                                        <button
                                            ref={(el) => {
                                                buttonRefs.current[`delete-${lead.id}-${index}`] = el;
                                            }}
                                            className="flex items-center justify-center text-[#727A90] hover:text-[#FC3400] transition-colors"
                                        >
                                        ...
                                        <div className="relative flex items-center">
                                            <button
                                                ref={(el) => {
                                                    buttonRefs.current[`${lead.id}-${index}`] = el;
                                                }}
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    const button = buttonRefs.current[`${lead.id}-${index}`];
                                                    const deleteButton = buttonRefs.current[`delete-${lead.id}-${index}`];
                                                    if (button) {
                                                        ...
                                                        let leftPosition = rect.left - popupWidth;

                                                        if (deleteButton) {
                                                            const deleteRect = deleteButton.getBoundingClientRect();
                                                            leftPosition = rect.left - popupWidth;
                                                        }
                                                        ...
                                                        setOpenPopupId(openPopupId === `${lead.id}-${index}` ? null : `${lead.id}-${index}`);
                                                    }
                                                }}
                                                className="flex items-center justify-center text-[#727A90] hover:text-[#24282E] transition-colors"
                                            >
                                                <svg width="24" height="24" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <PopUp
                                                isOpen={openPopupId === `${lead.id}-${index}`}
