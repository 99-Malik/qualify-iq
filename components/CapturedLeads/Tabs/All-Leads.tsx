...
const leads: Lead[] = [
    { id: 'LD-0024', name: 'Alice Smith', company: 'Bob Johnson', budget: '$2,000-$3,000', date: '15 Jan 2022', stage: 'Completed', hasAction: false },
    { id: 'LD-0024', name: 'Bob Johnson', company: 'Carlos Martinez', budget: '$2,000-$3,000', date: '3 Feb 2022', stage: 'FDD Signed', hasAction: true },
    { id: 'LD-0024', name: 'Charlie Brown', company: 'Diana Wong', budget: '$2,000-$3,000', date: '28 Mar 2022', stage: 'Rejected', hasAction: false },
    { id: 'LD-0024', name: 'Diana Prince', company: 'Eva Green', budget: '$2,000-$3,000', date: '7 Apr 2022', stage: 'Approved', hasAction: true },
    { id: 'LD-0024', name: 'Ethan Hunt', company: 'Frank Brown', budget: '$2,000-$3,000', date: '19 May 2022', stage: 'Completed', hasAction: false },
    { id: 'LD-0024', name: 'Fiona Gallagh...', company: 'Grace Lee', budget: '$2,000-$3,000', date: '11 Jun 2022', stage: 'FDD Signed', hasAction: true },
    { id: 'LD-0024', name: 'George Cost...', company: 'Henry King', budget: '$2,000-$3,000', date: '22 Jul 2022', stage: 'Rejected', hasAction: false },
    { id: 'LD-0024', name: 'Hannah Baker', company: 'Ivy Patel', budget: '$2,000-$3,000', date: '14 Aug 2022', stage: 'Approved', hasAction: true },
    { id: 'LD-0024', name: 'Ian Malcolm', company: 'Jack Taylor', budget: '$2,000-$3,000', date: '5 Sep 2022', stage: 'Completed', hasAction: false },
    // Add more leads for pagination
    { id: 'LD-0025', name: 'John Doe', company: 'ABC Corp', budget: '$2,000-$3,000', date: '10 Oct 2022', stage: 'Approved', hasAction: true },
    { id: 'LD-0026', name: 'Jane Smith', company: 'XYZ Inc', budget: '$2,000-$3,000', date: '20 Nov 2022', stage: 'FDD Signed', hasAction: true },
    { id: 'LD-0027', name: 'Mike Wilson', company: 'Tech Solutions', budget: '$2,000-$3,000', date: '5 Dec 2022', stage: 'Rejected', hasAction: false },
    { id: 'LD-0028', name: 'Sarah Johnson', company: 'Global Services', budget: '$2,000-$3,000', date: '15 Jan 2023', stage: 'Completed', hasAction: false },
    { id: 'LD-0029', name: 'Tom Brown', company: 'Digital Media', budget: '$2,000-$3,000', date: '25 Feb 2023', stage: 'Approved', hasAction: true },
    { id: 'LD-0030', name: 'Lisa Anderson', company: 'Creative Agency', budget: '$2,000-$3,000', date: '8 Mar 2023', stage: 'FDD Signed', hasAction: true },
    { id: 'LD-0031', name: 'David Lee', company: 'Marketing Pro', budget: '$2,000-$3,000', date: '18 Apr 2023', stage: 'Rejected', hasAction: false },
    { id: 'LD-0032', name: 'Emily Davis', company: 'Business Solutions', budget: '$2,000-$3,000', date: '28 May 2023', stage: 'Completed', hasAction: false },
];

const getStageColor = (stage: Lead['stage']): string => {
    switch (stage) {
        case 'Completed':
            return '#5542F6'; // purple
        case 'FDD Signed':
            return '#FFA043'; // orange
        case 'Rejected':
            return '#FC3400'; // red
        case 'Approved':
            return '#14B13B'; // green
...
export default function AllLeads() {
    ...
    const tableHeaders = [
        ...
        { label: 'Stage', hasCheckbox: false, hasSortIcon: true, className: 'py-4 px-4' },
                    ...
                    <tbody>
                        {paginatedLeads.map((lead, index) => (
                            ...
                            >
                                ...
                                <td className="py-4 px-4">
                                    <span className="font-medium text-[14px]" style={{ color: getStageColor(lead.stage) }}>
                                        {lead.stage}
                                    </span>
                                </td>
                                <td className="py-4 px-4">
                                    {lead.hasAction ? (
                                        ...
                                        <span className="text-[#727A90] text-sm">--</span>
                                    )}
                                </td>
                                <td className="py-4 px-4">
                                            ...
                                            <button
                                                ...
                                                onClick={(e) => {
                                                    ...
                                                    if (button) {
                                                        ...
                                                        // Position popup to the left, overlapping the delete icon
                                                        // The popup's right edge should align with the three dots button's left edge
                                                        let leftPosition = rect.left - popupWidth;
                                                        
                                                        // If delete button exists, position popup to overlap it
                                                        if (deleteButton) {
                                                            const deleteRect = deleteButton.getBoundingClientRect();
                                                            // Position so popup overlaps delete icon (popup right edge at three dots left, popup extends left over delete)
