                    ...
                    <div className="px-4 pb-4 pt-3 space-y-4">
                        ...
                        <div>
                            <input
                                ...
                                placeholder={`Untitled Question ${index + 1}`}
                                className="w-full px-3 py-5 bg-[#fbfafc] border-b border-[#E4E7EC] text-[#24282E] text-sm placeholder:text-[#727A90] focus:outline-none"
                            />
                        </div>

                        {/* Text Formatting Toolbar */}
                        <div className="flex items-center gap-1">
                            <button className="w-10 h-10 flex items-center justify-center border border-none rounded bg-[#fbfafc] hover:bg-[#F7F8FA] transition-colors">
                                <span className="font-bold text-md text-[#24282E]">B</span>
                            </button>
                            <button className="w-10 h-10  flex items-center justify-center  border border-none bg-[#fbfafc] rounded hover:bg-[#F7F8FA] transition-colors">
