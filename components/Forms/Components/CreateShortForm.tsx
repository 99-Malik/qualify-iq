...
import SetSuccessCriteria from './SetSuccessCriteria';
...
export default function CreateShortForm({ formId, initialFormData, onBack, onFormSaved }: CreateShortFormProps) {
    const router = useRouter();
    const isEditMode = !!formId;
    const [currentStep, setCurrentStep] = useState<'create' | 'criteria'>('create');
    // Preload form data when in edit mode
    ...
    // If on criteria step, show SetSuccessCriteria component
    if (currentStep === 'criteria') {
        return (
            <SetSuccessCriteria
                ...
                initialCriteria={initialFormData?.criteria}
    ...
    return (
        <div>
            ...
            {/* Form Title Input and Action Buttons - Responsive Layout */}
